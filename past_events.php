...
<font face='Verdana' color="#000000" size='2'>View past events</font> |
<strong><a href="my_events.php">View upcoming  events</a></strong>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5" >
<?php
     $num_events=$events->get_num_events_past($_SESSION["member_id"]);
     if($num_events==0)
     {
?>
<tr>
<td>
<p>You do not have any past events yet.</p>
</td>
</tr>
<?php
     }
...
<?php
     $event_res=$events->get_my_events_past($_SESSION["member_id"]);
