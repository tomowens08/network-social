...
<?php
        ...
        $n_previous=$n-12;
?>
&#187; <a href='my_video_favorite.php?cat_id=<?=$HTTP_GET_VARS["cat_id"]?>&n=<?=$n_previous?>'>Previous</a>
<?
        }
        if($next==1)
        {
?>
&nbsp;&#187; <a href='my_video_favorite.php?cat_id=<?=$HTTP_GET_VARS["cat_id"]?>&n=<?=$n_next?>'>Next</a>
<?php
        }
?>
</td>
...
<?php
     $sr_no=1;
     $front_res=$videos->display_my_favorite($_SESSION["member_id"],$n);
