...
<?php
        ...
        $n_previous=$n-12;
?>
&#187; <a href='most_disscussed.php?cat_id=<?=$HTTP_GET_VARS["cat_id"]?>&n=<?=$n_previous?>'>Previous</a>
<?
        }
        if($next==1)
        {
?>
&nbsp;&#187; <a href='most_disscussed.php?cat_id=<?=$HTTP_GET_VARS["cat_id"]?>&n=<?=$n_next?>'>Next</a>
<?php
        }
?>
</td>
...
<?php
     $sr_no=0;
     $front_res=$videos->display_most_disscussed_vids($n);
