...
<title>Php Gmail Address Book Importer</title>
<style><!--
...
<img border="0" src="img/gmail_logo.jpg" width="132" height="58"></div>
<br/>
<div style="text-align:center; margin:0px auto;">

	<div style="text-align:left; width:350px; margin:0px auto; padding:5px; border:2px solid #ddd; background-image:url(img/bg.jpg); background-repeat:repeat-x;" class=stxt>
		<div>Welcome to <b>Gmail Address Book Importer</b>!<br/>Please enter the username and password:-</div>
		<div><hr noshade color="#DDDDDD" size="1"></div>
		<form method="POST" action="import_gmail.php">
				<table border="0" cellpadding="2" width="100%" class=stxt cellspacing="2">
					<tr>
						<td>E-mail Address:</td>
						<td>
						<input type="text" name="EmailAddress" style="width:120px;" class=stxt value="<?=htmlspecialchars(stripslashes(@$_POST['EmailAddress']),ENT_QUOTES);?>"> @gmail.com</td>
					</tr>
					<tr>
						<td>Password:</td>
