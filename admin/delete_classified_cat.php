  ...
  else
{
  ...
  print "<td class='headcell' width='100%' height='20'>Delete a Classified Category</td></tr>";
  ...
  print "<form name='AddSpeciality' action='delete_classified_cat1.php?id=$HTTP_GET_VARS[id]' method='post'>";
  ...
  print "<td class='text'><input type='submit' value='Delete a Category'></td>";
