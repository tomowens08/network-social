...
print("<form name='theForm' action='main_page1.php' method='post'>");

print("<tr bgColor='#ffffff'>");
print("<td class='smalltext' vAlign='top'><p align='left'>Main Page Text :</p></td>");
...
// HTML Editor Code
?>
<textarea name="details" style="width:550; height:500"><?=stripslashes($data_set["main_text"])?></textarea>
<script language="javascript1.2">
editor_generate('details');
</script>
<br>
<div align='center'>
<INPUT type=submit value='Change Main Page Text' name=Submit>
</div>
<?
