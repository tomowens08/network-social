  ...
  else
{
  ...
  print "<td class='headcell' width='100%' height='20'>Edit a classified sub category</td></tr>";
  ...
  print "<form name='AddSpeciality' action='edit_classified_sub_cat1.php?id=$HTTP_GET_VARS[id]' method='post'>";
  ...
  print "<td class='text'><input type='submit' value='Edit Sub Category'></td>";
