  ...
  else
{
  ...
  print "<td class='headcell' width='100%' height='20'>Delete a Events Category</td></tr>";
  ...
  print "<form name='AddSpeciality' action='delete_event_cat1.php?id=$HTTP_GET_VARS[id]' method='post'>";
