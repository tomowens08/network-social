  ...
  else
{
  ...
  print "<td class='headcell' height='20' width='100%'>Search Classified Ad by Name</td></tr>";
...
$sql="select * from members a, classified_listing b ";
$sql.=" where a.member_id = b.member_id and b.subject like '%$HTTP_GET_VARS[class_name]%'";
...
{
 $n_previous=$n-30;
 print "&#187; <a href='search_class_name1.php?class_name=$HTTP_GET_VARS[class_name]&n=$n_previous'>Previous Page</a>";
}
if($next==1)
{
 print "&nbsp;&#187; <a href='search_class_name1.php?class_name=$HTTP_GET_VARS[class_name]&n=$n_next'>Next Page</a>";
}
print "</td>";
print "</tr>";
  ...
  print "</tr>";
        ...
        $sql="select * from members a, classified_listing b where a.member_id = b.member_id and b.subject like '%$HTTP_GET_VARS[class_name]%' order by id limit $n,30";
        $result=mysql_query($sql);
        $sr_no=1;
