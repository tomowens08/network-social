  ...
  else
{
  ...
  print "<td class='headcell' height='20'>Delete a music genre</td></tr>";
...
$cat_desc=$HTTP_POST_VARS["cat_desc"];
    ...
    else
  {
     ...
     $group=new music;
     $res=$group->delete_genre($HTTP_GET_VARS["id"], $cat_name, $cat_desc);
     if($res)
     {
         print "The genre has been deleted successfully.";
     }
     else
     {
