  ...
  else
{
  ...
  print "<form name='ChangePassword' action='admin_password1.php?admin_id=".$HTTP_GET_VARS["admin_id"]."' method='post'>";
  ...
  print "<tr bgColor='#ffffff'>";
  print "<td class='text'><p align='left'>Old Password:</p></td>";
  print "<td class='text'><input type='password' name='old_password' size='20'></td>";
  print "</tr>";

  print "<tr bgColor='#ffffff'>";
  print "<td class='smalltext' vAlign='top'><p align='left'>New Password:</p></td>";
  print "<td class='text'><input type='password' name='new_password' size='20'></td>";
  print "</tr>";

  print "<tr bgColor='#ffffff'>";
  print "<td class='smalltext' vAlign='top'>&nbsp;</td>";
  print "<td class='text'><input type='submit' value='Change Password'></td>";
