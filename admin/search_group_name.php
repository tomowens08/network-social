  ...
  else
{
  ...
  print "<form name='search' action='search_group_name1.php' method='get'>";

        print "<tr bgColor='#ffffff'>";
        print "<td class='textcell' valign='top' width='30%'>Group Name:</td>";
        print "<td class='textcell' valign='top' width='70%'>";
        print "<input type='text' name='group_name' size='30'>";
        print "</td>";
        print "</tr>";
