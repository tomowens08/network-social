  ...
  else
{
  ...
  print "<form name='search' action='search_video_id1.php' method='get'>";

        print "<tr bgColor='#ffffff'>";
        print "<td class='textcell' valign='top' width='30%'>Video ID:</td>";
        print "<td class='textcell' valign='top' width='70%'>";
        print "<input type='text' name='video_id' size='30'>";
        print "</td>";
        print "</tr>";
