  ...
  else
{
  ...
  print "<td class='headcell' height='20'>Delete city</td></tr>";

  print "<tr><td height='13' class='textcell'><table>";

  print "<form name='AddSpeciality' action='delete_city1.php?city_id=".$HTTP_GET_VARS["city_id"]."' method='post'>";
...
<? 
  ...
  print "<td class='text'><input type='submit' value='Delete City'></td>";
