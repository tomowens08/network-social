...
print("<td class='headcell' height='20'>Change invite message</td></tr>");

print("<tr><td height='13' class='textcell'><table>");

print("<form name='theForm' action='invite1.php' method='post'>");

print("<tr bgColor='#ffffff'>");
print("<td class='smalltext' vAlign='top'><p align='left'>Invite Text :</p></td>");
...
// HTML Editor Code
?>
<textarea name="details" style="width:550; height:500"><?=stripslashes($data_set["invite_message"])?></textarea>
<script language="javascript1.2">
editor_generate('details');
</script>
<br>
<div align='center'>
<INPUT type=submit value='Change Invite Message' name=Submit>
</div>
<?
