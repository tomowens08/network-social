...
$sql="select * from members a, classified_listing b where a.member_id = b.member_id and b.id=$HTTP_GET_VARS[class_id]";
...
{
 $n_previous=$n-30;
 print "&#187; <a href='search_class_id1.php?class_id=$HTTP_GET_VARS[class_id]&n=$n_previous'>Previous Page</a>";
}
if($next==1)
{
 print "&nbsp;&#187; <a href='search_class_id1.php?class_id=$HTTP_GET_VARS[class_id]&n=$n_next'>Next Page</a>";
}
print "</td>";
print "</tr>";
  ...
  print "</tr>";
        ...
        $sql="select * from members a, classified_listing b where a.member_id = b.member_id and b.id = $HTTP_GET_VARS[class_id] order by id limit $n,30";
        $result=mysql_query($sql);
        $sr_no=1;
