  ...
  else
{
  ...
  print "<td class='headcell' height='20' width='100%'>Add a Moderator for Classifieds</td></tr>";
  ...
  print "</tr>";
  print "<form name='add_mod' action='add_classified_moderators.php' method='post'>";
  include("includes/conn.php");
  include("../classes/moderators.class.php");

    $moderators=new moderators;
    $moderators->display_moderators_classifieds();
