  ...
  else
{
  ...
  print "<td class='headcell' height='20' width='100%'>Manage Classified Sub Category</td></tr>";
  ...
  include("../includes/class.class.php");
    ...
    $group->display_admin_sub_cat1($HTTP_GET_VARS["id"]);

  print "<tr bgColor='#ffffff'>";
  print "<td class='textcell' valign='top' width='100%' colspan='4'><p align='center'><a href='add_classified_sub_cat.php' target='main'>Add New Classified Sub Category</a></p></td></tr>";
