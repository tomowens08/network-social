  ...
  else
{
  ...
  print "<td class='headcell' height='20' width='100%'>Search Members by Member ID</td></tr>";
...
{
 $n_previous=$n-30;
 print "&#187; <a href='search_member_id1.php?member_id=$HTTP_GET_VARS[member_id]&n=$n_previous'>Previous Page</a>";
}
if($next==1)
{
 print "&nbsp;&#187; <a href='search_member_id1.php?member_id=$HTTP_GET_VARS[member_id]&n=$n_next'>Next Page</a>";
}
print "</td>";
print "</tr>";
  ...
  print "</tr>";
        ...
        $sql="select * from members where member_id = $HTTP_GET_VARS[member_id] order by member_id limit $n,30";
        $result=mysql_query($sql);
        $sr_no=1;
