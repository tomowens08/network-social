  ...
  else
{
  ...
  print "<td class='headcell' width='100%' height='20'>Delete a Group Category</td></tr>";
  ...
  print "<form name='AddSpeciality' action='delete_group_cat1.php?id=$HTTP_GET_VARS[id]' method='post'>";
