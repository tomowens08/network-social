  ...
  else
{
  ...
  print "<td class='headcell' height='20' width='100%'>Search Events by Event Name</td></tr>";
...
$sql="select * from members a, events b where a.member_id = b.event_by and b.event_name like '%$HTTP_GET_VARS[event_name]%'";
...
{
 $n_previous=$n-30;
 print "&#187; <a href='search_event_name1.php?event_name=$HTTP_GET_VARS[event_name]&n=$n_previous'>Previous Page</a>";
}
if($next==1)
{
 print "&nbsp;&#187; <a href='search_event_name1.php?event_name=$HTTP_GET_VARS[event_name]&n=$n_next'>Next Page</a>";
}
print "</td>";
print "</tr>";
  ...
  print "<td class='textcell' valign='top' width='70%'>Event Name</td>";
  print "<td class='textcell' valign='top' width='10%'>&nbsp;</td>";
  print "</tr>";

        $sql="select * from members a, events b where a.member_id = b.event_by and b.event_name like '%$HTTP_GET_VARS[event_name]%' order by id limit $n,30";
        $result=mysql_query($sql);
        $sr_no=1;
  ...
  while($RSUser=mysql_fetch_array($result))
  {
    ...
    print "<a href='../view_event.php?event_id=$RSUser[id]' target='_blank'>$RSUser[event_name]</a>";
    ...
    print "</td>";
    print "<td class='textcell' valign='top' width='10%'><a href='delete_event.php?event_id=$RSUser[id]'>Delete</a></td>";
    print "</tr>";
    $sr_no=$sr_no+1;
  }
