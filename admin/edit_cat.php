  ...
  else
{
  ...
  print "<td class='headcell' width='100%' height='20'>Edit a forum main category</td></tr>";

  print "<tr><td height='13' class='textcell'><table>";

  print "<form name='AddSpeciality' action='edit_cat1.php?id=$HTTP_GET_VARS[id]' method='post'>";
