  ...
  else
{
  ...
  print "<td class='headcell' height='20'>Delete a forum main category</td></tr>";
...
$cat_desc=$HTTP_POST_VARS["cat_desc"];
    ...
    else
  {
     ...
     $forum=new forum;
     $res=$forum->delete_main_cat($HTTP_GET_VARS["id"]);

     if($res)
     {
         print "The category has been deleted successfully.<br>";
         print "<a href='modify_main_cat.php'>Delete More</a>";
     }
     else
     {
