  ...
  else
{
  ...
  print "<td class='headcell' width='100%' height='20'>Add a new classified category</td></tr>";

  print "<tr><td height='13' class='textcell'><table>";

  print "<form name='AddSpeciality' action='add_classified_cat1.php' method='post'>";
