  ...
  else
{
  ...
  print "<td class='headcell' height='20' width='100%'>Manage Group Category</td></tr>";
  ...
  print "<tr bgColor='#ffffff'>";
  print "<td class='textcell' valign='top' width='100%' colspan='4'><p align='center'><a href='add_group_cat.php' target='main'>Add New Group Category</a></p></td></tr>";
