  ...
  else
{
  ...
  print "<td class='headcell' width='100%' height='20'>Delete a forum sub category</td></tr>";

  print "<tr><td height='13' class='textcell'><table>";

  print "<form name='AddSpeciality' action='delete_sub_cat1.php?id=$HTTP_GET_VARS[id]' method='post'>";
