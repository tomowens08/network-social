  ...
  else
{
  ...
  print "<td class='headcell' width='100%' height='20'>Add a new Video Channel</td></tr>";

  print "<tr><td height='13' class='textcell'><table>";

  print "<form name='AddSpeciality' action='add_video_cat1.php' method='post'>";
  ...
  print "<td class='text'><input type='submit' value='Add Video Channel'></td>";
