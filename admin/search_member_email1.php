...
$sql="select * from members where member_email like '$HTTP_GET_VARS[member_email]'";
...
{
 $n_previous=$n-30;
 print "&#187; <a href='search_member_email1.php?member_email=$HTTP_GET_VARS[member_email]&n=$n_previous'>Previous Page</a>";
}
if($next==1)
{
 print "&nbsp;&#187; <a href='search_member_id1.php?member_email=$HTTP_GET_VARS[member_email]&n=$n_next'>Next Page</a>";
}
print "</td>";
print "</tr>";
  ...
  print "</tr>";
        ...
        $sql="select * from members where member_email like '$HTTP_GET_VARS[member_email]' order by member_id limit $n,30";
        $result=mysql_query($sql);
        $sr_no=1;
