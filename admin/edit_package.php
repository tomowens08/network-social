  ...
  else
{
  ...
  print "<td class='headcell' width='100%' height='20'>Edit a package</td></tr>";
  ...
  print "<form name='AddSpeciality' action='edit_package1.php?id=$HTTP_GET_VARS[id]' method='post'>";
  ...
  print "<td class='text'><input type='submit' value='Edit a Package'></td>";
