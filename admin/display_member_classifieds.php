  ...
  else
{
  ...
  print "<td class='headcell' height='20' width='100%'>Display Classified Ads By Members</td></tr>";
...
{
 $n_previous=$n-30;
 print "&#187; <a href='display_member_classifieds.php?n=$n_previous'>Previous Page</a>";
}
if($next==1)
{
 print "&nbsp;&#187; <a href='display_member_classifieds.php?n=$n_next'>Next Page</a>";
}
print "</td>";
print "</tr>";
  ...
  print "<td class='textcell' valign='top' width='50%'>Member Name</td>";
  print "<td class='textcell' valign='top' width='30%'>&nbsp;</td>";
  print "</tr>";
  ...
  while($RSUser=mysql_fetch_array($result))
  {
    ...
    print "<td class='textcell' valign='top' width='50%'><a href='../view_profile.php?member_id=$RSUser[member_id]' target='_blank'>$RSUser[member_name]</a> (E-Mail :) $RSUser[member_email]</td>";
    print "<td class='textcell' valign='top' width='30%'><a href='display_member_classifieds1.php?member_id=$RSUser[member_id]'>Display Ads</a></td>";
    print "</tr>";
    $sr_no=$sr_no+1;
  }
