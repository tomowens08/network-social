  ...
  else
{
  ...
  print "<form name='search' action='search_member_id1.php' method='get'>";

        print "<tr bgColor='#ffffff'>";
        print "<td class='textcell' valign='top' width='30%'>Member ID:</td>";
        print "<td class='textcell' valign='top' width='70%'>";
        print "<input type='text' name='member_id' size='30'>";
        print "</td>";
        print "</tr>";
