  ...
  else
{
  ...
  print "<form name='theForm' action='add_college1.php?state_id=".$HTTP_GET_VARS["state_id"]."' method='post'>";
...
<? 
  ...
  print "<tr bgColor='#ffffff'>";
  print "<td class='text'><p align='left'>College Name:</p></td>";
  print "<td class='text'><input type='text' name='school_name' size='20'></td>";
  print "</tr>";

  print "<tr bgColor='#ffffff'>";
  print "<td class='smalltext' vAlign='top'>&nbsp;</td>";
  print "<td class='text'><input type='submit' value='Add College'></td>";
