  ...
  else
{
  ...
  print "<td class='headcell' height='20' width='100%'>Manage Events Category</td></tr>";
  ...
  print "<tr bgColor='#ffffff'>";
  print "<td class='textcell' valign='top' width='100%' colspan='4'><p align='center'><a href='add_event_cat.php' target='main'>Add New Events Category</a></p></td></tr>";
