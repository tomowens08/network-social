  ...
  else
{
  ...
  print "<form name='search' action='search_video_name1.php' method='get'>";

        print "<tr bgColor='#ffffff'>";
        print "<td class='textcell' valign='top' width='30%'>Video Name:</td>";
        print "<td class='textcell' valign='top' width='70%'>";
        print "<input type='text' name='video_name' size='30'>";
        print "</td>";
        print "</tr>";
