  ...
  else
{
  ...
  print "<td class='headcell' width='100%' height='20'>Delete a Music Genre</td></tr>";
  ...
  print "<form name='AddSpeciality' action='delete_genre1.php?id=$HTTP_GET_VARS[id]' method='post'>";
  ...
  print "<td class='text'><input type='submit' value='Delete a Genre'></td>";
