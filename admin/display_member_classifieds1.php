...
$sql="select * from members a, classified_listing b where a.member_id = b.member_id and a.member_id=$HTTP_GET_VARS[member_id]";
...
{
 $n_previous=$n-30;
 print "&#187; <a href='display_member_classifieds1.php?member_id=$HTTP_GET_VARS[member_id]&n=$n_previous'>Previous Page</a>";
}
if($next==1)
{
 print "&nbsp;&#187; <a href='display_member_classifieds1.php?member_id=$HTTP_GET_VARS[member_id]&n=$n_next'>Next Page</a>";
}
print "</td>";
print "</tr>";
  ...
  print "</tr>";
        ...
        $sql="select * from members a, classified_listing b where a.member_id = b.member_id and a.member_id = $HTTP_GET_VARS[member_id] order by id limit $n,30";
        $result=mysql_query($sql);
        $sr_no=1;
