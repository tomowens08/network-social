  ...
  else
{
  ...
  print "<td class='headcell' height='20'>Add a new classified category</td></tr>";
...
$cat_desc=$HTTP_POST_VARS["cat_desc"];
    ...
    else
  {
     ...
     $res=$group->add_category($cat_name, $cat_desc);
     if($res)
     {
         print "The category has been added successfully.<br>";
         print "<a href='add_classified_cat.php'>Add More</a>";
     }
     else
     {
