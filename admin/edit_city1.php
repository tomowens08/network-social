  ...
  else
{
  ...
  print "<td class='headcell' height='20'>Edit a city</td></tr>";
    ...
    else
  {
        ...
        $sql="update cities set state_id=$HTTP_POST_VARS[state_name], city_name = '$HTTP_POST_VARS[city_name] where city_id = ".$HTTP_GET_VARS["city_id"];
        $result=mysql_query($sql);
          print "<tr bgColor='#ffffff'>";
          print "<td class='smalltext' vAlign='top'><p align='left'>The city has been edited successfully.</p></td>";
          print "</tr>";
  }
