  ...
  else
{
  ...
  print "<td class='headcell' height='20' width='100%'>Search Events by Event ID</td></tr>";
...
$sql="select * from members a, events b where a.member_id = b.event_by and b.id = $HTTP_GET_VARS[event_id]";
...
{
 $n_previous=$n-30;
 print "&#187; <a href='search_event_id1.php?event_id=$HTTP_GET_VARS[event_id]&n=$n_previous'>Previous Page</a>";
}
if($next==1)
{
 print "&nbsp;&#187; <a href='search_event_id1.php?event_id=$HTTP_GET_VARS[event_id]&n=$n_next'>Next Page</a>";
}
print "</td>";
print "</tr>";
  ...
  print "</tr>";
        ...
        $sql="select * from members a, events b where a.member_id = b.event_by and b.id = $HTTP_GET_VARS[event_id] order by id limit $n,30";
        $result=mysql_query($sql);
        $sr_no=1;
