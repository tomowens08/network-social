  ...
  else
{
  ...
  print "<td class='headcell' height='20'>Edit a group category</td></tr>";
...
$cat_desc=$HTTP_POST_VARS["cat_desc"];
    ...
    else
  {
     ...
     $group=new groups;
     $res=$group->edit_category($HTTP_GET_VARS["id"], $cat_name, $cat_desc);
     if($res)
     {
         print "The group category has been edited successfully.";
     }
     else
     {
         print "There was an error and the group category was not edited successfully.";
     }
  }
 }
print "</table></table>";
