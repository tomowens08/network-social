...
{
 $n_previous=$n-30;
 print "&#187; <a href='display_member_events.php?n=$n_previous'>Previous Page</a>";
}
if($next==1)
{
 print "&nbsp;&#187; <a href='display_member_events.php?n=$n_next'>Next Page</a>";
}
print "</td>";
print "</tr>";
  ...
  while($RSUser=mysql_fetch_array($result))
  {
    ...
    print "<td class='textcell' valign='top' width='30%'><a href='display_member_events1.php?member_id=$RSUser[member_id]'>Display Events</a></td>";
    print "</tr>";
    $sr_no=$sr_no+1;
  }
