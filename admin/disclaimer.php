...
print("<td class='headcell' height='20'>Change Promote Our Site Page Text</td></tr>");

print("<tr><td height='13' class='textcell'><table>");

print("<form name='theForm' action='edit_disclaimer.php' method='post'>");

print("<tr bgColor='#ffffff'>");
print("<td class='smalltext' vAlign='top'><p align='left'>Promote Our Site Page Text :</p></td>");
...
// HTML Editor Code
?>
<textarea name="details" style="width:550; height:500"><?=stripslashes($data_set["disclaimer_text"])?></textarea>
<script language="javascript1.2">
editor_generate('details');
</script>
<br>
<div align='center'>
<INPUT type=submit value='Change Promote Our Site Page Text' name=Submit>
</div>
<?
