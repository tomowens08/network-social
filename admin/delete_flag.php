  ...
  else
{
  ...
  print "<tr><td colspan='2' class='login' bgcolor='#B0B0B0'><b><p align='center'>Delete Flag</b></p></td></tr>";

        $sql="delete from profile_flag where flag_id = $HTTP_GET_VARS[flag_id]";
        $result=mysql_query($sql);
        print mysql_error();

  print "<tr>";
  print "<td width='100%' colspan='2' class='login'>";
  print "<p align='center'>The flag has been deleted successfully.</p>";
  print "</td></tr>";
