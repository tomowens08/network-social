  ...
  else
{
  ...
  print "<td class='headcell' height='20'>Add a new events category</td></tr>";
...
$cat_type=$HTTP_POST_VARS["cat_type"];
    ...
    else
  {
     ...
     $group=new events;
     $res=$group->add_category($cat_name, $cat_desc,$cat_type);
     if($res)
     {
         print "The category has been added successfully.<br>";
         print "<a href='add_event_cat.php'>Add More</a>";
     }
     else
     {
