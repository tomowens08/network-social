  ...
  else
{
  ...
  print "<td class='headcell' width='100%' height='20'>Delete a Blog Mood</td></tr>";
  ...
  print "<form name='AddSpeciality' action='delete_mood1.php?id=$HTTP_GET_VARS[id]' method='post' enctype='multipart/form-data'>";
  ...
  print "<td class='text'><input type='submit' value='Delete a Mood'></td>";
