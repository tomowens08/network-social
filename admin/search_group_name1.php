  ...
  else
{
  ...
  print "<td class='headcell' height='20' width='100%'>Search Groups by Group Name</td></tr>";
...
$sql="select * from members a, groups b where a.member_id = b.member_id and b.group_name like '%$HTTP_GET_VARS[group_name]%'";
...
{
 $n_previous=$n-30;
 print "&#187; <a href='search_group_name1.php?group_name=$HTTP_GET_VARS[group_name]&n=$n_previous'>Previous Page</a>";
}
if($next==1)
{
 print "&nbsp;&#187; <a href='search_group_name1.php?group_name=$HTTP_GET_VARS[group_name]&n=$n_next'>Next Page</a>";
}
print "</td>";
print "</tr>";
  ...
  print "</tr>";
        ...
        $sql="select * from members a, groups b where a.member_id = b.member_id and b.group_name like '%$HTTP_GET_VARS[group_name]%' order by id limit $n,30";
        $result=mysql_query($sql);
        $sr_no=1;
