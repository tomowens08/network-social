  ...
  else
{
  ...
  print "<td class='headcell' height='20'>Edit a package</td></tr>";
...
foreach($HTTP_POST_VARS["mods"] as $mods)
{
    ...
    else
  {
     ...
     $pack=new packages;
     $res=$pack->edit_package($HTTP_GET_VARS["id"], $package_name,$package_price,$allowed_mods);
     if($res)
     {
         print "The package has been edited successfully.";
     }
     else
     {
         print "There was an error and the package was not edited successfully.";
     }
  }
 }
print "</table></table>";
