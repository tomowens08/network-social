  ...
  else
{
  ...
  print "<td class='headcell' height='20'>Add a new music genre</td></tr>";
...
$cat_desc=$HTTP_POST_VARS["cat_desc"];
    ...
    else
  {
     ...
     $group=new music;
     $res=$group->add_genre($cat_name, $cat_desc);
     if($res)
     {
         print "The genre has been added successfully.<br>";
         print "<a href='add_genre.php'>Add More</a>";
     }
     else
     {
