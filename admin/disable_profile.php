  ...
  else
{
  ...
  print "<tr><td colspan='2' class='login' bgcolor='#B0B0B0'><b><p align='center'>Disable Profile</b></p></td></tr>";

        $sql="update members set enabled = '0' where member_id = $HTTP_GET_VARS[member_id]";
        $result=mysql_query($sql);
        print mysql_error();

  print "<tr>";
  print "<td width='100%' colspan='2' class='login'>";
  print "<p align='center'>The member account has been disabled successfully.</p>";
  print "</td></tr>";
