  ...
  else
{
  ...
  print "<td class='headcell' height='20'>Edit a forum sub category</td></tr>";
...
$main_cat=$HTTP_POST_VARS["main_cat"];
    ...
    else
  {
     ...
     $forum=new forum;
     $res=$forum->edit_sub_cat($id,$main_cat,$cat_name,$cat_desc);

     if($res)
     {
         print "The sub category has been edited successfully.<br>";
         print "<a href='modify_sub_cat.php'>Edit More</a>";
     }
     else
     {
