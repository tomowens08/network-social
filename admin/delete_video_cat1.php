  ...
  else
{
  ...
  print "<td class='headcell' height='20'>Delete a Video Channel</td></tr>";
...
$cat_desc=$HTTP_POST_VARS["cat_desc"];
    ...
    else
  {
     ...
     $videos=new videos;
     $res=$videos->delete_cat($HTTP_GET_VARS["id"]);
     if($res)
     {
         print "The video channel has been deleted successfully.";
     }
     else
     {
         print "There was an error and the video channel was not deleted successfully.";
     }
  }
 }
print "</table></table>";
