  ...
  else
{
  ...
  print "<tr><td colspan='2' class='login' bgcolor='#B0B0B0'><b><p align='center'>Delete Classified Ads</b></p></td></tr>";

        $sql = "delete from classified_listing where id = $HTTP_GET_VARS[id]";
        $result=mysql_query($sql);
        print mysql_error();

  print "<tr>";
  print "<td width='100%' colspan='2' class='login'>";
  print "<p align='center'>The classified ad has been deleted successfully.</p>";
  print "</td></tr>";
