...
print("<td class='headcell' height='20'>Change Contact Us Page Text</td></tr>");

print("<tr><td height='13' class='textcell'><table>");

print("<form name='theForm' action='login_page1.php' method='post'>");

print("<tr bgColor='#ffffff'>");
print("<td class='smalltext' vAlign='top'><p align='left'>Contact Us Page Text :</p></td>");
...
// HTML Editor Code
?>
<textarea name="details" style="width:550; height:500"><?=stripslashes($data_set["login_text"])?></textarea>
<script language="javascript1.2">
editor_generate('details');
</script>
<br>
<div align='center'>
<INPUT type=submit value='Change Contact Us Page Text' name=Submit>
</div>
<?
