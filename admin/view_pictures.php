  ...
  else
{
  ...
  print "<td class='headcell' height='20' width='100%'>".$RSUser["member_name"]."&nbsp;".$RSUser["member_lname"]."'s Pictures </td></tr>";
  ...
  print "</tr>";
        ...
        $sql="select * from photos where member_id = ".$HTTP_GET_VARS["member_id"];
        $result=mysql_query($sql);
  ...
  while($RSUser=mysql_fetch_array($result))
  {
    ...
    print "<td class='textcell' valign='top' width='20%'><a href='delete_picture.php?photo_id=$RSUser[photo_id]'>Delete Pictures</a></td>";
    print "</tr>";
    $sr_no=$sr_no+1;
  } 
