  ...
  else
{
  ...
  print "<td class='headcell' height='20' width='100%'>Modify Forum Sub Category</td></tr>";
  ...
  include("../classes/forum.class.php");
    ...
    $forum=new forum;
    $forum->display_admin_sub_cat($HTTP_GET_VARS["id"]);

  print "<tr bgColor='#ffffff'>";
  print "<td class='textcell' valign='top' width='100%' colspan='4'>";
  print "<p align='center'><a href='add_sub_cat.php' target='main'>Add New Forum Sub Category</a>";
  print "</p></td></tr>";
