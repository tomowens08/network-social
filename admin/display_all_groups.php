  ...
  else
{
  ...
  print "<td class='headcell' height='20' width='100%'>Display All Groups</td></tr>";
...
$sql="select * from members a, groups b where a.member_id = b.member_id";
...
{
 $n_previous=$n-30;
 print "&#187; <a href='display_all_groups.php?n=$n_previous'>Previous Page</a>";
}
if($next==1)
{
 print "&nbsp;&#187; <a href='display_all_groups.php?n=$n_next'>Next Page</a>";
}
print "</td>";
print "</tr>";
  ...
  print "</tr>";
        ...
        $sql="select * from members a, groups b where a.member_id = b.member_id order by id limit $n,30";
        $result=mysql_query($sql);
        $sr_no=1;
