  ...
  else
{
  ...
  print "<td class='headcell' height='20' width='100%'>Display All Videos</td></tr>";
...
$sql="select * from members a, video_members b where a.member_id = b.member_id";
...
{
 $n_previous=$n-30;
 print "&#187; <a href='display_all_videos.php?n=$n_previous'>Previous Page</a>";
}
if($next==1)
{
 print "&nbsp;&#187; <a href='display_all_videos.php?n=$n_next'>Next Page</a>";
}
print "</td>";
print "</tr>";
  ...
  print "</tr>";
        ...
        $sql="select * from members a, video_members b where a.member_id = b.member_id order by id limit $n,30";
        $result=mysql_query($sql);
        $sr_no=1;
