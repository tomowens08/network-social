  ...
  else
{
  ...
  print "<td class='headcell' height='20'>Edit a Video Channel</td></tr>";
...
$cat_desc=$HTTP_POST_VARS["cat_desc"];
    ...
    else
  {
     ...
     $videos=new videos;
     $res=$videos->edit_cat($HTTP_GET_VARS["id"], $cat_name, $cat_desc);
     if($res)
     {
         print "The video channel has been edited successfully.";
     }
     else
     {
         print "There was an error and the video channel was not edited successfully.";
     }
  }
 }
print "</table></table>";
