  ...
  else
{
  ...
  print "<td class='headcell' width='100%' height='20'>Edit a Music Genre</td></tr>";
  ...
  print "<form name='AddSpeciality' action='edit_genre1.php?id=$HTTP_GET_VARS[id]' method='post'>";
  ...
  print "<td class='text'><input type='submit' value='Edit a Genre'></td>";
