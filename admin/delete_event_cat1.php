  ...
  else
{
  ...
  print "<td class='headcell' height='20'>Delete a event category</td></tr>";
...
$cat_desc=$HTTP_POST_VARS["cat_desc"];
    ...
    else
  {
     ...
     $group=new events;
     $res=$group->delete_category($HTTP_GET_VARS["id"], $cat_name, $cat_desc);
     if($res)
     {
         print "The events has been deleted successfully.";
     }
     else
     {
