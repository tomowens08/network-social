  ...
  else
{
  ...
  print "<td class='headcell' width='100%' height='20'>Delete a forum main category</td></tr>";

  print "<tr><td height='13' class='textcell'><table>";

  print "<form name='AddSpeciality' action='delete_cat1.php?id=$HTTP_GET_VARS[id]' method='post'>";

        include("includes/conn.php");
        include("../classes/forum.class.php");
        $forum=new forum;
        $cat_info=$forum->get_main_cat($HTTP_GET_VARS["id"]);
  ...
  print "<td class='text'><input type='submit' value='Delete Category'></td>";
