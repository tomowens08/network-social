...
{
 $n_previous=$n-30;
 print "&#187; <a href='member_invites.php?n=$n_previous'>Previous Page</a>";
}
if($next==1)
{
 print "&nbsp;&#187; <a href='member_invites.php?n=$n_next'>Next Page</a>";
}
print "</td>";
print "</tr>";
  ...
  while($RSUser=mysql_fetch_array($result))
  {
    ...
    print "<td class='textcell' valign='top' width='20%'><a href='view_invites.php?member_id=".$RSUser["member_id"]."'>View Invites</a></td>";
    print "</tr>";
    $sr_no=$sr_no+1;
  } 
