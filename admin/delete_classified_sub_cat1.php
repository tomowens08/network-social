  ...
  else
{
  ...
  print "<td class='headcell' height='20'>Delete a classified sub category</td></tr>";
...
$cat_desc=addslashes($HTTP_POST_VARS["cat_desc"]);
    ...
    else
  {
     ...
     $res=$group->delete_sub_cat($id);
     if($res)
     {
         print "The category has been deleted successfully.<br>";
         print "<a href='modify_classified_sub_cat.php'>Delete More</a>";
     }
     else
     {
