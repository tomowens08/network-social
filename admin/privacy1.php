  ...
  else
{
  ...
  print "<td class='headcell' height='20'>Change Privacy Policy</td></tr>";

  print "<tr><td height='13' class='textcell'><table>";
  include("includes/conn.php");
  $details=addslashes($HTTP_POST_VARS["details"]);

        $sql="update privacy set privacy_text = '$details'";
        $result=mysql_query($sql);
        print mysql_error();
        
  print "<tr bgColor='#ffffff'>";
  print "<td class='smalltext' vAlign='top'><p align='left'>The privacy policy has been edited successfully.</p></td>";
  print "</tr>";
}
