  ...
  else
{
  ...
  print "<td class='headcell' width='100%' height='20'>Edit a Classified Category</td></tr>";
  ...
  print "<form name='AddSpeciality' action='edit_classified_cat1.php?id=$HTTP_GET_VARS[id]' method='post'>";
