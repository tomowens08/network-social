...
<?
  ...
  print "<form name='AddTestimonial' action='rate_song1.php?&member_id=$HTTP_GET_VARS[member_id]&id=$HTTP_GET_VARS[id]' method='post'>";
  ...
  print "<tr>";
  print "<td width='100%' colspan='2' class='login'><p align='center'><input type='submit' name='submit' value='Add Rating'></p></td></tr>";
  print "</form>";
