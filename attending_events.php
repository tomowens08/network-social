...
<table border="0" cellspacing="0" cellpadding="10" bgcolor="#FFFFFF" align="center">
<tr>
<td>&nbsp;</td>
</td>
...
<table width="100%" border="0" cellspacing="0" cellpadding="0" bordercolor="#FF6600" bgcolor=6699CC>
<tr>
<td>
<table width="100%" border="0" cellspacing="0" cellpadding="1" bordercolor="#FF6600" bgcolor=FFFFFF>
<TR>
<TD align=center>
...
<font face='Verdana' color="#000000" size='2'><a href="my_events.php" class="man">Events I've Posted</a>&nbsp;|&nbsp;</font>
...
<table width="100%" border="0" cellspacing="0" cellpadding="5" >
<?php
     $num_events=$events->get_num_events_attending($_SESSION["member_id"]);
     if($num_events==0)
     {
?>
<tr>
...
<?php
     $event_res=$events->get_my_events_attending($_SESSION["member_id"]);
