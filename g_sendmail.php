...
$msgfile="g_invite_email.php"; //enter the filename which points to your mail content file in html format e.g. "mailmessage.html"
...
print "<tr><td width='100%'><p align='left'><font face='Verdana' color='#000000' size='2'><b><a href='group_invite.php' class='style11'>Back to Invite section</b></font></td></tr>";
print "<br>";
print "<br>";
?>
</body>
