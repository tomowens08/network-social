...
<?
  ...
  print "<h3>Groups who have contacted you!</h3></td></tr>";


        $sql="select * from invitations where member_id = ".$_SESSION["member_id"]." and approve = 0";
    ...
    else
  {
    ...
    while($RSUser1=mysql_fetch_array($result1))
    {
      ...
      if ($num_rows!=0)
      {
        ...
        print "<table width='100%'>";
        print "<tr><td width='100%' class='login'><a href='approve_group_invite.php?group_id=".$RSUser2["id"]."'>Approve</a></td></tr>";
