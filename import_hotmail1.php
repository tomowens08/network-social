...
<?php
  ...
  print "<b><p align='center'>Import Address Book From Hotmail</b></p></td></tr>";
  ...
  {
      $login_name=$login_name."@hotmail.com";
     ...
     if($hotmail->list['Foward']==Null)
     {
      print "<tr>";
      print "<td width='100%' colspan='2' class='txt_label'>";
      print "<p align='center'><b>Invalid Login, Could not login to Hotmail.</b></p>";
      print "</td></tr>";
     }
     else
     {
