...
<title>Php Hotmail Address Book Importer</title>
<style><!--
...
<img border="0" src="img/hotmail_logo.jpg" width="132" height="58"></div>
<br/>
<div style="text-align:center; margin:0px auto;">
	...
	<div style="text-align:left; width:350px; margin:0px auto; padding:5px; border:2px solid #ddd; background-image:url(bg.jpg); background-repeat:repeat-x;" class=stxt>
		<div>Welcome to <b>Hotmail Address Book Importer</b>!<br/>Please enter the username and password:-</div>
		<div><hr noshade color="#DDDDDD" size="1"></div>
		<form method="POST" action="import_hotmail.php">
				<table border="0" cellpadding="2" width="100%" class=stxt cellspacing="2">
					<tr>
						<td>E-mail Address:</td>
						<td>
						<input type="text" name="EmailAddress" style="width:120px;" class=stxt value="<?=htmlspecialchars(stripslashes(@$_POST['EmailAddress']),ENT_QUOTES);?>"> @hotmail.com</td>
					</tr>
					<tr>
						<td>Password:</td>
