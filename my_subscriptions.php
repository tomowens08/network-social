...
<td width="100%" bgcolor="A5D5F5" class='txt_label' style="color:black; font-weight: bold; font-size: 10pt;">&nbsp;&nbsp;&nbsp;My Subscriptions</td>
</tr>
...
<td width="100" align="center" valign="middle" class='txt_label'><strong>Edit Options</strong></td>
</tr>
...
<?php
     ...
     {
        $name=$people->get_name($sub_set["sub_member_id"]);
?>
<tr align="left" valign="top" bgcolor="FFFFFF">
<td width="15" class='txt_label' align="center" valign="middle">
<a href="view_profile.php?member_id=<?=$sub_set["sub_member_id"]?>" target="_blank">
<img src="images/preview.bmp" alt="Preview" width="15" border="0"></a></td>
<td class='txt_label' valign="middle">
<a href="view_profile.php?member_id=<?=$sub_set["sub_member_id"]?>" target="_blank"><?=$name?></a></td>
