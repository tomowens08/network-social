...
{
?>
<form name='send_back' action='join_us.php?country_id=<?=$country_id?>&err=3' method='post'>
<?php
}
else
{
?>
<form name='send_back' action='join_us.php?country_id=<?=$country_id?>&err=1' method='post'>
<?php
}
?>
...
else
{
    ...
    if($num_rows==1)
    {
        // send user back
?>
<form name='send_back' action='join_us.php?country_id=<?=$country_id?>&err=2' method='post'>
<input type='hidden' name='email' value='<?=$email?>'>
<input type='hidden' name='first_name' value='<?=$first_name?>'>
<input type='hidden' name='last_name' value='<?=$last_name?>'>
<input type='hidden' name='state' value='<?=$state?>'>
