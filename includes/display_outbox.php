<?php
      ...
      else
    {
        ...
        $sql="select * from messages_sent where mess_by = $_SESSION[member_id] and deleted <> 1 order by date_posted desc limit $n,20";
        $res=mysql_query($sql);
...
<td width='30%' align="center" class='txt_label'>
<?php
