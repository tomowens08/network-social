...
<tr valign="top">
<td class='dark_blue_white2'>&nbsp;Edit School:<br>
</td>
</tr>
<tr><td>
...
<tr>
<td>
<form name='interests' action='edit_school1.php?id=<?=$HTTP_GET_VARS["id"]?>' method='post'>
...
<td><input type="text" name="school_name" size='40' value='<?=stripslashes($school_set["school_name"])?>'>
</td>
</tr>

<tr>
<td><font color="356BA2" size="2"><b>City:</b></font></td>
<td><input type="text" name="city" size='40' value='<?=stripslashes($school_set["school_city"])?>'>
</tr>

<tr>
<td><font color="356BA2" size="2"><b>State:</b></font></td>
<td><input type="text" name="state" size='30' value='<?=stripslashes($school_set["school_state"])?>'>
</tr>
...
<td><input type="text" size="40" name="major" value='<?=stripslashes($school_set["major"])?>'></td>
</tr>

<tr>
<td><font color="356BA2" size="2"><b>Current Courses:</b></font></td>
<td><input type="text" size="40" name="courses" value='<?=stripslashes($school_set["current_courses"])?>'></td>
</tr>
<tr>
<td><font color="356BA2" size="2"><b>Clubs/Organizations:</b></font></td>
<td><textarea cols="40" rows="10" name="clubs"><?=stripslashes($school_set["clubs_organizations"])?></textarea></td>
</tr>
</table>
...
<td>
<input type="submit" name='submit' value="Edit School">
</td>
</tr>
</table>
</form>
