...
<table width='100%' border="0" cellpadding="0" class="dark_b_border2">
<tr>
<td class='dark_blue_white2'>Currently Listed Schools</td>
</tr>
<tr>
<td>
...
<tr valign="top">
<td class='dark_blue_white2'>&nbsp;Edit Company:
</td>
</tr>
<tr>
<td>
...
<?php
    $company_set=$profile->get_company($HTTP_GET_VARS["id"]);
?>
<tr>
<td>
<form name='interests' action='edit_company1.php?id=<?=$HTTP_GET_VARS["id"]?>' method='post'>
...
<td>
<input type="text" name="company_name" size="40" value='<?=stripslashes($company_set["company_name"])?>'><br><br>
</td>
</tr>
...
<td>
<input type="text" name="city" size="40" value='<?=stripslashes($company_set["company_city"])?>'><br><br>
</td>
</tr>
...
<td><input type="text" name="state" size="40" value='<?=stripslashes($company_set["company_state"])?>'><br><br></td>
</tr>
<tr valign="top">
<td align="right" width="145"><b><font color="356BA2" face="verdana" size="2">Country:&nbsp;&nbsp;</font></b></td>
<td><input type="text" name="country" size="40" value='<?=stripslashes($company_set["company_country"])?>'><br><br></td>
</tr>
...
<td><input type="text" name="dates" size="50" maxlength="255" value='<?=stripslashes($company_set["date_employed"])?>'><br><br></td>
</tr>
<tr valign="top">
...
<td><input type="text" name="title" size="40" value='<?=stripslashes($company_set["title"])?>'><br><br></td>
</tr>
<tr valign="top">
<td align="right" width="145" height="6"><b><font color="356BA2" face="verdana" size="2">Division:&nbsp;&nbsp;</font></b></td>
<td height="6"><input type="text" name="division" size="40" value='<?=stripslashes($company_set["division"])?>'><br><br></td>
</tr>
</table>
