...
<tr valign="top">
<td class='dark_blue_white2'>&nbsp;Delete Company:
</td>
</tr>
<tr>
<td>
...
<tr>
<td>
<form name='interests' action='delete_company1.php?id=<?=$HTTP_GET_VARS["id"]?>' method='post'>
...
<td>
<input type="text" name="company_name" size="40" value='<?=$company_set["company_name"]?>'><br><br>
</td>
</tr>
...
<td>
<input type="text" name="city" size="40" value='<?=$company_set["company_city"]?>'><br><br>
</td>
</tr>
...
<td><input type="text" name="state" size="40" value='<?=$company_set["company_state"]?>'><br><br></td>
</tr>
<tr valign="top">
<td align="right" width="145"><b><font color="356BA2" face="verdana" size="2">Country:&nbsp;&nbsp;</font></b></td>
<td><input type="text" name="country" size="40" value='<?=$company_set["company_country"]?>'><br><br></td>
</tr>
...
<td><input type="text" name="dates" size="50" maxlength="255" value='<?=$company_set["date_employed"]?>'><br><br></td>
</tr>
<tr valign="top">
...
<td><input type="text" name="title" size="40" value='<?=$company_set["title"]?>'><br><br></td>
</tr>
<tr valign="top">
<td align="right" width="145" height="6"><b><font color="356BA2" face="verdana" size="2">Division:&nbsp;&nbsp;</font></b></td>
<td height="6"><input type="text" name="division" size="40" value='<?=$company_set["division"]?>'><br><br></td>
</tr>
</table>
...
<td>
<input type="submit" name='submit' value="Delete Company">
</td>
</tr>
</table>
</form>
