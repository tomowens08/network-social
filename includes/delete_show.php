...
<tr>
<td class='txt_label'>Music <b>&gt;&gt;</b> Delete Upcoming Shows
</span>
</td>
<td align="right">
...
?>
<form name="insert_company_form" method="post" action="delete_show1.php?id=<?=$HTTP_GET_VARS["id"]?>">
...
<input class='txt_topic' id=formSubmit type='submit' value='Delete' border=0 name=formSubmit height="26" width="70">
</td>
</tr>
</tbody>
</table>
