...
<tr valign="top">
<td class='dark_blue_white2'>&nbsp;Delete Network:</td></tr>
<tr><td>

<table width="100%" border="0" cellspacing="0" cellpadding="10" bgcolor="FFFFFF">
<?php
    $network_set=$profile->get_network($HTTP_GET_VARS["id"]);
?>
<tr>
<td>
<form name='interests' action='delete_networking1.php?id=<?=$HTTP_GET_VARS["id"]?>' method='post'>
...
<td>
<input type="text" name="field" size="40" value='<?=$network_set["field"]?>'><br><br>
</td>
</tr>
...
<td>
<input type="text" name="sub_field" size="40" value='<?=$network_set["sub_field"]?>'><br><br>
</td>
</tr>
...
<td><input type="text" name="role" size="40" value='<?=$network_set["role"]?>'><br><br></td>
</tr>
<tr valign="top">
<td align="right" width="145"><b><font color="356BA2" face="verdana" size="2">Description:&nbsp;&nbsp;</font></b></td>
<td><textarea name="desc" rows="10" cols='50'><?=$network_set["description"]?></textarea><br><br></td>
</tr>
...
<td>
<input type="submit" name='submit' value="Delete Networking">
</td>
</tr>
</table>
</form>
