...
<?
  ...
  print "<tr><td colspan='2' class='dark_blue_white2'><b><p align='center'><span class='style18'>$RSUser[song_name]'s Ratings</span></b></p></td></tr>";
     ...
     $people=new people;
        ...
        $sql="select * from song_rating where song_id = $HTTP_GET_VARS[id]";
  ...
  if ($num_rows==0)
  {
    ...
    print "There are no testimonials for this member yet.";
    ...
    else
  {
    ...
    while($RSUser1=mysql_fetch_array($result1))
    {
     ...
     $num_images=$people->get_num_images($RSUser1["rating_by"]);
     if($num_images==0)
     {
         $gender=$people->check_gender($RSUser1["rating_by"]);
         if($gender=="Male")
         {
     ...
     {
        $image_url=$people->get_image($RSUser1["rating_by"]);
      ...
      print "</td>";
        ...
        $sql="select * from members where member_id = ".$RSUser1["rating_by"];
        $result=mysql_query($sql);
        $RSUser=mysql_fetch_array($result);
      ...
      print "</td></tr>";
      print "<tr><td width='100%' class='txt_label'>";
      print "<b>Rating Given:</b> $RSUser1[rating]/10</a>";
      print "</td></tr>";
      print "<tr><td width='100%' class='txt_label'>$RSUser1[rating_comment]</td></tr>";
      print "</table>";
      print "</td>";
