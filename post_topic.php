...
<tr><td align="center">
<form method="post" action="post_topic_action.php?main_cat=<?=$HTTP_GET_VARS["main_cat"]?>&sub_cat=<?=$HTTP_GET_VARS["sub_cat"]?>">
<table border="0" cellspacing="1" cellpadding="5"  bgcolor="#330000">
<tr bgcolor="#330000"><td nowrap colspan="2" class='fontmain'><b>Enter Your New Topic</b></td></tr>
