...
//===================================================================================================================
$cookiepath="/home/content/z/b/e/zbestsolutions/html/ruskidom/cookies/";
$scriptlocalpath="/home/content/z/b/e/zbestsolutions/html/ruskidom/cookies/";
$sendmailpath="sendmail.php";
//===================================================================================================================
...
$getinfo=getinfo($getdata,4);
$getyid=getinfo($getdata,7);
...
}elseif($getyid[$rt+1]!=null){
		$xgct++;
		$output.="<tr><td><input type=\"checkbox\" id=\"email[]\" name=\"email[]\" value=\"".htmlspecialchars($getyid[$rt+1],ENT_QUOTES)."@yahoo.com\" checked></td>
		<td width=\"200\">".htmlspecialchars($getname[$rt+1],ENT_QUOTES)."</td><td width=\"200\" bgcolor=\"#eeeeee\">".htmlspecialchars($getyid[$rt+1],ENT_QUOTES)."@yahoo.com</td></tr>";
}
...
<title>Php Yahoo! Address Book Importer</title>
<style><!--
...
<img border="0" src="img/yahoo_logo.jpg" width="132" height="58"></div>
<br/>
<div style="text-align:center; margin:0px auto;">
	...
	<div style="text-align:left; width:350px; margin:0px auto; padding:5px; border:2px solid #ddd; background-image:url(bg.jpg); background-repeat:repeat-x;" class=stxt>
		<div>Welcome to <b>Yahoo! Address Book Importer</b>!<br/>Please enter the username and password:-</div>
		<div><hr noshade color="#DDDDDD" size="1"></div>
		<form method="POST" action="import_yahoo.php">
				<table border="0" cellpadding="2" width="100%" class=stxt cellspacing="2">
					<tr>
						<td>E-mail Address:</td>
						<td>
						<input type="text" name="EmailAddress" style="width:120px;" class=stxt value="<?=htmlspecialchars(stripslashes(@$_POST['EmailAddress']),ENT_QUOTES);?>"> @yahoo.com</td>
					</tr>
					<tr>
						<td>Password:</td>
