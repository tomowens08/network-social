...
<tr>
<td class='txt_label'><font size="2"><b>Videos<br>My Videos</b></font></td>
...
<?php
     $album_res=$videos->get_member_videos($_SESSION["member_id"]);
...
<a href="view_video.php?id=<?=$album_set["id"]?>" class="mailtext"><?=stripslashes($album_set["video_title"])?></a>
<br>
Number of Views: <?=$album_set["views"]?>
</td>
<td align="center" class='txt_label'>
[<a href='delete_video.php?id=<?=$album_set["id"]?>'>Delete Video</a>]
</td>
</tr>
<?php
     }
