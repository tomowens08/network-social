...
function up_clearICNotify( clearDestID, bForceClear )
{
	...
	{	
		frames['up_icLauncher'].location.href = "index.cfm?fuseaction=messenger.icOpened&destinationUserID=" + clearDestID + "&doPresence=" + ( up_bDoPresence && !up_is_win_ie ? "true" : "false" ) + "&forceClear=" + ( bForceClear ? "true" : "false" ) + "&iRefreshInterval=" + up_iCheckSeconds + "&refresh=" + Math.floor( Math.random() * 100000000000 );
	}
