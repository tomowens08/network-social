...
<table width="800" border="0" cellspacing="0" cellpadding="2" align="center" bordercolor="#6699CC" bgcolor="#FFFFFF" height=100%>
...
<?php
     ...
     if($type==1)
     {
      ...
      if($HTTP_GET_VARS["Photos"]=="1")
      {
        $sql_paging="select count(*) as a from members a, photos b where a.member_id = b.member_id";
      ...
      if($HTTP_GET_VARS["Photos"]=="1")
      {
        $sql="select * from members a, photos b where a.member_id = b.member_id";
        if($HTTP_GET_VARS["searchrequest"]!=Null)
        {
     ...
     if($type==2)
     {
      ...
      if($HTTP_GET_VARS["Photos"]=="1")
      {
        ...
        {
         $sql_paging.=" and member_name like '%$HTTP_GET_VARS[f_first_name]%'";
        }
        if($HTTP_GET_VARS["searchBy"]=="Display")
        {
         $sql_paging.=" and display_name like '%$HTTP_GET_VARS[f_first_name]%'";
        }
        if($HTTP_GET_VARS["searchBy"]=="EMail")
        {
         $sql_paging.=" and email like '%$HTTP_GET_VARS[f_first_name]%'";
        }
        if($HTTP_GET_VARS["country"]!=Null && $HTTP_GET_VARS["country"]!="0")
        {
            $sql_paging.=" and country like '%$HTTP_GET_VARS[country]%'";
        }
      }
      else
      {
      ...
      if($HTTP_GET_VARS["Photos"]=="1")
      {
        ...
        if($HTTP_GET_VARS["searchBy"]=="First")
        {
         $sql.=" and member_name like '%$HTTP_GET_VARS[f_first_name]%'";
        }
        if($HTTP_GET_VARS["searchBy"]=="Display")
        {
        ...
        if($HTTP_GET_VARS["searchBy"]=="EMail")
        {
         $sql.=" and email like '%$HTTP_GET_VARS[f_first_name]%'";
        }
        if($HTTP_GET_VARS["country"]!=Null && $HTTP_GET_VARS["country"]!="0")
        {
            $sql.=" and country like '%$HTTP_GET_VARS[country]%'";
        }
      }
      else
      {
     ...
     if($type==3)
     {
      ...
      if($HTTP_GET_VARS["Photos"]=="1")
      {
        $sql_paging="select count(*) as a from members a, photos b, profile_school c where a.member_id = b.member_id and a.member_id=c.member_id";
      ...
      {
        $sql_paging="select count(*) as a from members a, profile_school c where a.member_id=c.member_id";
        if($HTTP_GET_VARS["school_name"]!=Null)
        {
         $sql_paging.=" and school_name like '%$HTTP_GET_VARS[school_name]%'";
        }
      ...
      if($HTTP_GET_VARS["Photos"]=="1")
      {
        $sql="select * from members a, photos b, profile_school c where a.member_id = b.member_id and a.member_id=c.member_id";
        if($HTTP_GET_VARS["school_name"]!=Null)
        {
      ...
      {
        $sql="select * from members a, profile_school c where a.member_id=c.member_id";
        if($HTTP_GET_VARS["school_name"]!=Null)
        {
         $sql.=" and school_name like '%$HTTP_GET_VARS[school_name]%'";
        }
...
print mysql_error();
        ...
        while($data_set=mysql_fetch_array($result))
        {
         if($HTTP_GET_VARS["distance"]!=Null&&$HTTP_GET_VARS["postal"]!=Null)
         {
          ...
          $sql="select zip_code from members where member_id = $data_set[member_id]";
...
if($type==1)
{
        ...
        $n_previous=$n-10;
?>
&#187; <a href='search_profiles_advanced.php?type=<?=$type?>&searchrequest=<?=$HTTP_GET_VARS["searchrequest"]?>&country=<?=$HTTP_GET_VARS["country"]?>&Photos=<?=$HTTP_GET_VARS["Photos"]?>&NoDetail=<?=$HTTP_GET_VARS["NoDetail"]?>&n=<?=$n_previous?>'>Previous</a>
<?
        }
        if($next==1)
        {
?>
&nbsp;&#187; <a href='search_profiles_advanced.php?type=<?=$type?>&searchrequest=<?=$HTTP_GET_VARS["searchrequest"]?>&country=<?=$HTTP_GET_VARS["country"]?>&Photos=<?=$HTTP_GET_VARS["Photos"]?>&NoDetail=<?=$HTTP_GET_VARS["NoDetail"]?>&n=<?=$n_next?>'>Next</a>
<?php
        }
}
?>
...
if($type==2)
{
        ...
        $n_previous=$n-10;
?>
&#187; <a href='search_profiles_advanced.php?type=<?=$type?>&searchBy=<?=$HTTP_GET_VARS["searchBy"]?>&f_first_name=<?=$HTTP_GET_VARS["f_first_name"]?>&country=<?=$HTTP_GET_VARS["country"]?>&Photos=<?=$HTTP_GET_VARS["Photos"]?>&NoDetail=<?=$HTTP_GET_VARS["NoDetail"]?>&n=<?=$n_previous?>'>Previous</a>
<?
        }
        if($next==1)
        {
?>
&nbsp;&#187; <a href='search_profiles_advanced.php?type=<?=$type?>&searchBy=<?=$HTTP_GET_VARS["searchBy"]?>&f_first_name=<?=$HTTP_GET_VARS["f_first_name"]?>&country=<?=$HTTP_GET_VARS["country"]?>&Photos=<?=$HTTP_GET_VARS["Photos"]?>&NoDetail=<?=$HTTP_GET_VARS["NoDetail"]?>&n=<?=$n_next?>'>Next</a>
<?php
        }
}
?>
...
if($type==3)
{
        ...
        $n_previous=$n-10;
?>
&#187; <a href='search_profiles_advanced.php?type=<?=$type?>&school_name=<?=$HTTP_GET_VARS["school_name"]?>&state=<?=$HTTP_GET_VARS["state"]?>&country=<?=$HTTP_GET_VARS["country"]?>&Photos=<?=$HTTP_GET_VARS["Photos"]?>&NoDetail=<?=$HTTP_GET_VARS["NoDetail"]?>&n=<?=$n_previous?>'>Previous</a>
<?
        }
        if($next==1)
        {
?>
&nbsp;&#187; <a href='search_profiles_advacned.php?type=<?=$type?>&school_name=<?=$HTTP_GET_VARS["school_name"]?>&state=<?=$HTTP_GET_VARS["state"]?>&country=<?=$HTTP_GET_VARS["country"]?>&Photos=<?=$HTTP_GET_VARS["Photos"]?>&NoDetail=<?=$HTTP_GET_VARS["NoDetail"]?>&n=<?=$n_next?>'>Next</a>
<?php
        }
}
?>
