...
<?
  ...
  print "<h4>My Journal (Delete a Comment)</h4></td></tr>";
        ...
        $sql.=" where comment_id = $HTTP_GET_VARS[comment_id]";
        $result=mysql_query($sql);

        if($result)
        {
                        print "<tr><td width='100%'><p align='left'><font face='Verdana' color='#000000' size='2'><b>Your Coment Has Been Deleted!!!</b></font></td></tr>";
