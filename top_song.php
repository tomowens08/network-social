...
<strong><font color="#FFFFFF">&nbsp;&nbsp;Top Rated Artists by Users</font></strong>
</td>
</tr>
</table>
...
<?php
        ...
        $sql_paging="select count(*) as a from members a, song_rating b, music_songs c ";
        $sql_paging.=" where a.member_id = c.member_id";
        $sql_paging.=" and b.song_id = c.id";
     ...
     $sr_no=1;
     $sql="select a.*, avg(b.rating) as rank, c.*  from members a, song_rating b, music_songs c ";
     $sql.=" where a.member_id = c.member_id and b.song_id = c.id ";
...
<br>&nbsp;<b>Song: <?=$data_set["song_name"]?></b>
</td>
</tr>
</table>
</td>
