...
<?php
            ...
            $res=$profile->edit_company($id,$_SESSION["member_id"],$company_name,$city,$state,$country,$dates,$title,$division);

            if($res==1)
            {
                print "<tr><td colspan='2' class='txt_label'>";
                print "Your company has been edited.";
                print "<br><br>";
            ...
            {
                print "<tr><td colspan='2' class='txt_label'>";
                print "There was an error and the company was not edited at this time.";
                print "</td></tr>";
            }
